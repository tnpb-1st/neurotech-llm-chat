...
class InsightsGenerator:
    ...
    def __init__(self):
        ...
        self.prompt = PromptTemplate.from_template(template=INSIGHTS_GENERATOR_TEMPLATE).partial(db_schema=TABLE_INFO)
    ...
    def generate_insights(self, input_dict: dict) -> str:
        ...
        """
        if not input_dict or "error" in input_dict or ("data" in input_dict and len(input_dict["data"]) == 0):
